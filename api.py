...
st.sidebar.image('rf team2.png', use_column_width=True )
...
if pagSelecionada == 'Home':
    ...
    with col1:
        img = Image.open("rf2.png" ) 
        st.image(img)
    with col2:
        img = Image.open("rf2.png" ) 
        st.image(img)
    with col3:
        img = Image.open("rf3 logo.png" ) 
        st.image(img)
    with col4:
        img = Image.open("rf2.png" ) 
        st.image(img)
